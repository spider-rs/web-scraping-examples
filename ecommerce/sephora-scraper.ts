 ...
 * Sephora Scraper
 *
 * Extract beauty product listings, shade ranges, pricing, and customer reviews fro
 *
 * Usage: SPIDER_API_KEY=sk-... npx tsx sephora-scraper.ts
 */
...
await page.goto("https://www.sephora.com/shop/foundation-makeup");
await page.content();
