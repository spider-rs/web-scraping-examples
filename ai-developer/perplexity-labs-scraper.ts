/**
 * Perplexity Labs Scraper
 *
 * Extract API documentation, model options, search-augmented generation examples, 
 *
 * Usage: SPIDER_API_KEY=sk-... npx tsx perplexity-labs-scraper.ts
 */
...
await page.goto("https://docs.perplexity.ai/docs/getting-started");
